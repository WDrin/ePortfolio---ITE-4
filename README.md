...
<body>
    ...
    <div class="container">
        <section id="about" class="section" style="display: flex; align-items: center;">
            <img src="D:\cursor\picture\photo_2024-01-28_12-26-54.jpg" alt="Profile Picture"
        ...
        <section id="projects" class="section">
            <div class="projects">
                <div class="project-card">
                    ...
                    <a href="D:/cursor/project1.html" class="view-project-button">View Project</a>
                </div>
                <div class="project-card">
                    <h3 style="font-size: 30px;">Midterm</h3>
                    <!--<p>Description of project 2</p>-->
                    <a href="D:/cursor/project2.html" class="view-project-button">View Project</a>
                </div>
                <div class="project-card">
                    <h3 style="font-size: 30px;">Final Term</h3>
                    <!--<p>Description of project 3</p>-->
                    <a href="D:/cursor/project3.html" class="view-project-button">View Project</a>
                </div>
            </div>
        </section>
